...
public class InlineCssTextArea extends StyledTextArea<String, String> {
     ...
     * Creates a blank area
     */
    public InlineCssTextArea(@NamedArg("behaviorParameters") GenericStyledAreaBehaviorParameters behaviorParameters) {
        this(new SimpleEditableStyledDocument<>("", ""), behaviorParameters);
    }
